...
def test_concurrent_charges(stripe_context: APIRequestContext, test_customer):
    """Simulate concurrent charges — tests fixture scope under parallel execution."""
    charges = []
    for amount in ["1000", "2000", "3000"]:
        r = stripe_context.post("/charges", form={
            "amount": amount,
            "currency": "usd",
            "source": "tok_visa",
            "customer": test_customer["id"],
